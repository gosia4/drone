...
ANNOT_PATH            = "C:/Users/gosia/OneDrive - vus.hr/klatki_przyciete_7mb/test"
# OUTPUT_PATH           = 'predicted_images/' + MODEL_NAME + "/pr"
OUTPUT_PATH           = 'predicted_images/' + MODEL_NAME + "/przyciete_7mb"
DETECT_BATCH          = False
DETECT_WHOLE_VID      = True
BATCH_SIZE            = 1804
# IMAGE_PATH            = ANNOT_PATH + "/free_3/free_3_frame_100"
IMAGE_PATH            = ANNOT_PATH + "/frame_32"
INPUT_SIZE            = 416
SCORE_THRESHOLD       = 0.8
IOU_THRESHOLD         = 0.45
...
def main():
    ...
    if DETECT_BATCH:
        ...
        # obtain name of the tests that are the same for image and labels_1 directories
        ...
        while batch != BATCH_SIZE:
            ...
            for test_name in name_of_tests:
                ...
                # obtain path for images and labels_1 for specific test
